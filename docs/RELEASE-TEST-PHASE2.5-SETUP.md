# 릴리즈 테스트 SQL 스크립트 - Phase 2.5 설정 가이드 (섹션 0~3)

- **버전**: v3.1.2  
- **최종 업데이트**: 2025-11-10 03:15:00 KST  
- **다음 문서**: [Phase 2.5 시나리오 테스트](RELEASE-TEST-PHASE2.5-SCENARIOS.md)
...
➡️ **[Phase 2.5 시나리오 테스트](RELEASE-TEST-PHASE2.5-SCENARIOS.md)로 이동**
